...
function Cards() {
  ...
  return (
    <div className="my-16 grid grid-cols-1 md:grid-cols-3 gap-8 px-6">
...
function Card({ heading, para, cardbg }) {
  return (
    <div
      className={`${cardbg} p-14 rounded-full shadow-lg transform transition-all duration-300 hover:scale-105 hover:shadow-2xl flex flex-col items-center text-center`}
    >
...
function About() {
  return (
    <section className="w-full min-h-screen bg-gray-200">
      <Cover>
        <h2 className="text-6xl text-center font-bold py-20 text-white">About Us</h2>
      </Cover>
      <div className="sm:w-[90vw] md:w-4/5 mx-auto flex flex-col py-16 px-6">
        <p className="lg:w-3/4 mx-auto text-lg  text-center leading-relaxed">
